"""
Django settings for mygutenberg project.
...
SECRET_KEY = 'django-insecure-t5x_-5-*te)g9r+#$%dgb79unr!41l8)m69g3(w#(!4vmu9wvn'
...
WSGI_APPLICATION = 'mygutenberg.wsgi.application'
